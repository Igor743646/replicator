use super::charset::CharacterDecoder;
...
impl CharSet7Bit {
    pub fn new(name : &'static str, map  : &'static [u16]) -> Self {
        Self {name, map}
    }
}

impl CharacterDecoder for CharSet7Bit {
    fn decode(&self, string : &mut [u8], length: &mut usize) -> u64 {
        std::unimplemented!()
    }
}

pub const UNICODE_MAP_US7_ASCII : &'static [u16] = &[
